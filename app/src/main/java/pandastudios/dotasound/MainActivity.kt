...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    lateinit var favouritesList: ArrayList<Board>
...
//            }
    ...
    private fun setupLists() {
        ...
        favourites_list.layoutManager = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)
        recents_list.adapter = HomeRecycler(this, recentsList)
        recents_list.layoutManager = LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false)
    ...
    private fun setupDiscover() {
        ...
        val soundArrays = SoundArrays(this)
        val boardCategory = Math.floor(Math.random() * 4).toInt()

        when (boardCategory) {
            0 -> {
                titleArray = resources.getStringArray(R.array.strength_heroes)
                imageArray = soundArrays.strength_board_headers
            }
            1 -> {
                titleArray = resources.getStringArray(R.array.agility_heroes)
                imageArray = soundArrays.agility_board_headers
            }
            2 -> {
                titleArray = resources.getStringArray(R.array.intelligence_heroes)
                imageArray = soundArrays.intelligence_board_headers
            }
            3 -> {
                titleArray = resources.getStringArray(R.array.misc_items)
                imageArray = soundArrays.misc_board_headers
            }
            else -> {
                titleArray = resources.getStringArray(R.array.misc_items)
                imageArray = soundArrays.misc_board_headers
