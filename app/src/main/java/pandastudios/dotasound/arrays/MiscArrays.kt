...
class MiscArrays(val context: Context) {
    ...
    val misc_items = arrayOf(
            R.drawable.board_header_music,
            R.drawable.board_header_ti7,
            R.drawable.header_ti8,
            R.drawable.header_rickandmorty,
            R.drawable.header_gabenewell
    )

    // Board Headers
    val board_header_music = R.drawable.board_header_music
    val ti7_board_header = R.drawable.board_header_ti7
    val ti8_board_header = R.drawable.header_ti8
    val rickandmorty_board_header = R.drawable.header_rickandmorty
    val gabenewell_board_header = R.drawable.header_gabenewell
